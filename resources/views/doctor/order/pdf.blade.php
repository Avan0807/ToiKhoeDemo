...
<html>
<head>
  <title>Đặt hàng @if($order)- {{$order->cart_id}} @endif</title>
...
<style type="text/css">
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,)}} đ</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{number_format($order->sub_total,)}} đ</span></th>
        </tr>
  ...
  <div class="thanks mt-3">
    <h4>Cảm ơn bạn đã mua hàng của chúng tôi!!</h4>
  </div>
  <div class="authority float-right mt-5">
    <p>-----------------------------------</p>
    <h5>Chữ ký của người có thẩm quyền:</h5>
  </div>
  <div class="clearfix"></div>
@else
