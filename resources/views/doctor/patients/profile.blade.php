...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('user')}}" style="color:#999">Trang tổng quan</a></li>
                      ...
                      <div class="form-group">
                          ...
                          <select name="role" class="form-control">
                              <option value="">-----Chọn vai trò-----</option>
                                  <option value="admin" {{(($profile->role=='admin')? 'selected' : '')}}>Quản trị viên</option>
                                  <option value="user" {{(($profile->role=='user')? 'selected' : '')}}>Người dùng</option>
                                  <option value="doctor" {{(($profile->role=='doctor')? 'selected' : '')}}>Bác sĩ</option>
                          </select>
                        @error('role')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
