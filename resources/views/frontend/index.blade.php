...
@section('main-content')
        ...
        <section class="custom-banner-section py-3">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 mb-lg-0 mb-3" style="padding-right: 0px">
                        <section id="Gslider" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @foreach ($banners as $key => $banner)
                            ...
                            <div class="carousel-inner" id="Banner-larger" role="listbox">
                                @foreach ($banners as $key => $banner)
                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        <img class="first-slide" src="{{ $banner->photo }}" alt="First slide">
                                        <div class="carousel-caption d-none d-md-block text-left">
    ...
    <section class="small-banner section">
        <div class="container-fluid">
            @php
                $category_lists = DB::table('categories')->where('status', 'active')->limit(6)->get(); // Lấy tối đa 6 mục
            @endphp
            @if ($category_lists && count($category_lists) > 0)
                <!-- Splide Slider -->
                <div id="categorySplide" class="splide">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            new Splide('#categorySplide', {
                ...
                perPage: 4, // Hiển thị 4 mục mỗi lần
                gap: '1rem', // Khoảng cách giữa các mục
                breakpoints: { // Responsive
                    1024: {
                        perPage: 3
                    }, // 3 mục trên màn hình nhỏ hơn 1024px
                    768: {
                        perPage: 2
                    }, // 2 mục trên màn hình nhỏ hơn 768px
                    576: {
                        perPage: 1
                    } // 1 mục trên màn hình nhỏ hơn 576px
                },
            }).mount();
        });
    </script>
