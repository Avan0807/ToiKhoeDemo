...
<div class="container">
    ...
    <div class="video-call-guide py-5">
        <h2 class="text-center text-primary mb-4">Khám từ xa qua video call</h2>
        <p class="text-center text-muted mb-5">Không chỉ tiện lợi, còn rất kỹ lưỡng</p>
        <div class="row g-3">
            <div class="col-md-3">
                <div class="guide-step bg-white shadow-sm rounded p-3 h-100">
                    <div class="step-header d-flex align-items-center mb-3">
                        <div class="step-number text-white bg-primary rounded-circle text-center me-3">01</div>
            ...
            <div class="col-md-3">
                <div class="guide-step bg-white shadow-sm rounded p-3 h-100">
                    <div class="step-header d-flex align-items-center mb-3">
                        <div class="step-number text-white bg-warning rounded-circle text-center me-3">02</div>
                        <h5 class="mb-0">Trước hẹn</h5>
                    </div>
                    <p>Tải các kết quả xét nghiệm, hình ảnh, toa thuốc đã dùng và quay video trình bày tình trạng sức khỏe.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="guide-step bg-white shadow-sm rounded p-3 h-100">
                    <div class="step-header d-flex align-items-center mb-3">
                        <div class="step-number text-white bg-success rounded-circle text-center me-3">03</div>
            ...
            <div class="col-md-3">
                <div class="guide-step bg-white shadow-sm rounded p-3 h-100">
                    <div class="step-header d-flex align-items-center mb-3">
                        <div class="step-number text-white bg-info rounded-circle text-center me-3">04</div>
    ...
    <h2 class="text-center my-4">Danh sách bác sĩ</h2>
    <p class="text-center text-muted mb-5">Khám bệnh từ xa, ngồi nhà hỏi đáp cùng chuyên gia y tế</p>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card doctor-card h-100 shadow">
                <img src="{{ $doctor->profile_picture ?? asset('default-avatar.png') }}" class="card-img-top doctor-avatar rounded-circle mx-auto mt-3" alt="{{ $doctor->name }}">
    ...
    <div class="modal fade" id="appointmentModal" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="appointmentForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="appointmentModalLabel">Đặt lịch hẹn với <span id="doctorName"></span></h5>
        ...
        <ul class="faq-list bg-light p-3 rounded">
            <li><i class="fa fa-question-circle"></i> Các thông tin bệnh nhân mà tôi đưa lên hệ thống có bị các bác sĩ khác thấy hay có nguy cơ lộ thông tin không?</li>
    ...
    <div class="thank-you-section mt-5">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="thank-card p-3 bg-light rounded shadow-sm">
                    <p><i class="fa fa-quote-left text-primary"></i> Rất tuyệt vời, đặc biệt trong mùa dịch đi lại khó khăn. Chúc doctor ngày càng phát triển và mở rộng phạm vi ra nhiều tỉnh hơn.</p>
                    <p class="text-end"><strong>- Duy Nguyễn Nhật</strong></p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="thank-card p-3 bg-light rounded shadow-sm">
                    <p><i class="fa fa-quote-left text-primary"></i> Ứng dụng rất hay. Giúp mọi người hạn chế bệnh gì cũng phải đến bệnh viện khám. Đỡ mất thời gian, công sức và tiền bạc.</p>
...
.step-number.bg-primary:hover, .step-number.bg-warning:hover, .step-number.bg-success:hover, .step-number.bg-info:hover {
        ...
        appointmentForm.addEventListener('submit', function (e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert(data.error || 'Đã xảy ra lỗi, vui lòng thử lại.');  // Hiển thị lỗi từ server
                }
            })
            .catch(error => {
