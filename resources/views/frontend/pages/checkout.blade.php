                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Hoàn tất việc mua hàng của bạn</h2>
                                <p>Chỉ cần thêm vài bước nữa là bạn có thể hoàn tất giao dịch mua hàng một cách an toàn!</p>
                                <!-- Form -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Dòng địa chỉ 1<span>*</span></label>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Bản tin</h4>
                            <p> Đăng ký nhận bản tin của chúng tôi và được giảm giá <span>10%</span> cho lần mua đầu tiên của bạn</p>
