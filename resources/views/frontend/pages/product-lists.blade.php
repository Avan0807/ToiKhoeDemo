...
@section('title','CODY || TRANG SẢN PHẨM')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Danh sách cửa hàng</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Mới thêm gần đây</h3>
                                    {{-- {{dd($recent_products)}} --}}
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">Rất tiếc, không có sản phẩm nào theo phạm vi được cung cấp. Hãy thử chọn sản phẩm khác để xem thêm kết quả.</h4>
								@endif
							</div>
							 <div class="row">
